...
struct WiFiConfig {
  WiFiPair pairs[6];  // SSID/パスワードペア6組
};
...
public:
  ...
  static void setWiFiPassword(int index, const String& pass);
  static void setWiFiPair(int index, const String& ssid, const String& pass);
