/**
 * StateReporterIs06a.h
 *
 * IS06A用 状態レポート送信
 */

#ifndef STATE_REPORTER_IS06A_H
#define STATE_REPORTER_IS06A_H
...
class StateReporterIs06a {
public:
    StateReporterIs06a();

    void begin(SettingManager* settings, NtpManager* ntp, TriggerManagerIs06a* trigger);
    ...
    // 状態送信
    // force=true: インターバル制限を無視（トリガーイベント用）
