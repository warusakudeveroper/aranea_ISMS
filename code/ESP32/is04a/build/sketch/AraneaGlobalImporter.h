#line 1 "/Users/hideakikurata/Library/CloudStorage/Dropbox/Mac (3)/Documents/aranea_ISMS/code/ESP32/is04a/AraneaGlobalImporter.h"
/**
 * AraneaGlobalImporter.h (is04a用)
 *
 * ============================================================
...
// ============================================================
// IS04A固有モジュール（is04a/ディレクトリ内）
// ============================================================
#include "Is04aKeys.h"            // NVSキー定数
#include "AraneaSettings.h"       // 施設設定（大量生産用）
#include "TriggerManager.h"       // 入出力連動管理
#include "HttpManagerIs04a.h"     // Web UI実装
#include "StateReporterIs04a.h"   // 状態レポート構築
...
inline void printAraneaGlobalModules() {
  Serial.println("=== Aranea Global Modules (is04a) ===");
