...
| ID | タスク | 依存 | ステータス | 担当 |
|----|--------|------|----------|------|
| P0-1 | プロジェクトスケルトン作成 | - | ⬜ 未着手 | - |
| P0-2 | AraneaGlobalImporter.h作成 | P0-1 | ⬜ 未着手 | - |
| P0-3 | GPIO初期化実装 | P0-2 | ⬜ 未着手 | - |
| P0-4 | WiFiManager統合 | P0-2 | ⬜ 未着手 | - |
| P0-5 | SettingManager統合（NVSキー定義） | P0-2 | ⬜ 未着手 | - |
| P0-6 | 基盤動作確認（WiFi接続・NVS読み書き） | P0-3,4,5 | ⬜ 未着手 | - |
| **P0-7** | **AraneaSettingsDefaults実装** | P0-2 | ⬜ 未着手 | - |
| **P0-8** | **PINglobal NVS初期化実装** | P0-5,7 | ⬜ 未着手 | - |
