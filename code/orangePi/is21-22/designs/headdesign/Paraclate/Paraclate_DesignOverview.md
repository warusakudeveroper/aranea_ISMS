...
- 現在のis21も同様にlacisIDを持つがT9999999999999999999のシステムテナント、fid9966のシステム専用論理施設(実施設ではなく管理上の論理施設)に所属するUserObjectである。このデバイスはPermission71の権限を持つ特殊デバイスでありPermission71はクロステナント権限とfid=0000の全施設アクセス権限を持つため複数のtidからの処理に応じることができる。
